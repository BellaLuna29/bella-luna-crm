...
const PATHS: Record<IconName, string> = {
  ...
  package:
    '<path d="M11 21.73a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73Z"/><path d="M12 22V12"/><path d="M3.3 7.3 12 12l8.7-4.7"/><path d="M7.5 4.27 16.5 9.4"/>',
